...
import { mostrarAlerta, mostrarConfirmacion } from "../../../utils/alerts";
...
// =======================================================
// EVENTOS DE CANTIDADES / ELIMINAR
// =======================================================
...
// =======================================================
// CREAR EL PEDIDO (POST al backend)
// =======================================================
...
form.addEventListener("submit", async (e) => {
  ...
  const pedido = {
    ...
    infoEntrega: {
      ...
      metodoPago: (document.getElementById("metodoPago") as HTMLSelectElement).value,
      nota: (document.getElementById("nota") as HTMLTextAreaElement).value
    }
  };
